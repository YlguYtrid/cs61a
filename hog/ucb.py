...
def main(fn: Callable[..., None]) -> Callable[..., None]:
    ...
    if inspect.stack()[1][0].f_locals['__name__'] == '__main__':
        args: list[str] = sys.argv[1:]  # Discard the script name from command line
